...
window.messageHandler = __webpack_require__(/*! ./messageHandler */ "./resources/js/messageHandler.js");
window.formHandler = __webpack_require__(/*! ./formHandler */ "./resources/js/formHandler.js");
window.httpService = __webpack_require__(/*! ./httpService */ "./resources/js/httpService.js");
window.dataTableHandler = __webpack_require__(/*! ./dataTableHandler */ "./resources/js/dataTableHandler.js");
...
/***/ "./resources/js/dataTableHandler.js":
/*!******************************************!*\
  !*** ./resources/js/dataTableHandler.js ***!
  \******************************************/
...
exports.initializeTable = function (tableId, columns) {
  ...
  if (indexUrl) {
    _this.loadData(dataTable, indexUrl);
  } // Return Data Table
...
exports.handleDelete = function (table, url) {
  ...
  table.on("click", ".delete-button", function () {
    ...
    var data = table.row($(this).parents("tr")).data(); // Ask For Delete Confirmation
    ...
    sweetAlert.fire({
      ...
      if (confirmation.isConfirmed) {
        ...
        Object.keys(parameters).forEach(function (urlParameter) {
          deleteUrl = deleteUrl.replace(":".concat(urlParameter), data[urlParameter]);
        }); // Delete Record From The Database

        httpService["delete"](deleteUrl).then(function (response) {
...
exports.handleShow = function (table, url) {
  var parameters = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
  var handleShowCallback = arguments.length > 3 ? arguments[3] : undefined;
  ...
  table.on("click", ".edit-button", function () {
    ...
    var editUrl = url;
    Object.keys(parameters).forEach(function (urlParameter) {
      editUrl = editUrl.replace(":".concat(urlParameter), data[urlParameter]);
    }); // Get Data From The API
...
exports.handleShow = function (formId) {
  var inputs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  ...
  $updateUrl = $("#".concat(formId)).data("action");
  Object.keys(parameterIndexes).forEach(function (urlParameter) {
    $updateUrl = $updateUrl.replace(":".concat(urlParameter), data[urlParameter]);
  }); // Set Form Action URL

  $("#".concat(formId)).attr("action", $updateUrl); // Display Edit Modal
...
exports.handleEdit = function (formId) {
  var inputs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  var callback = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
  var modal = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
...
var _require = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"),
    axios = _require["default"]; // Setup Headers And Authentication Parameters
...
var showMessage = function showMessage(title, body, icon, type) {
...
exports.successMessage = function (title) {
  var body = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  showMessage(title, body, "fas fa-check-circle", "bg-success");
}; // Display Warning Messages


exports.warningMessage = function (title) {
  var body = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  showMessage(title, body, "fas fa-exclamation-triangle", "bg-warning");
}; // Display Error Messages


exports.errorMessage = function (title) {
  var body = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
...
/******/ 	__webpack_require__.O(undefined, ["css/frontend","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/frontend","css/app"], () => (__webpack_require__("./resources/css/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/frontend","css/app"], () => (__webpack_require__("./resources/css/frontend.scss")))
