v<div class="modal fade" id="paymentAppointmentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="paymentModalLabel"><i
                    class="fas fa-fw fa-hand-holding-usd mr-2"></i>{{ __('app.headers.channelingPayments') }}</h5>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    formHandler.handleSave(`paymentAppointmentForm`, ["reason", "amount"], loadChannelingPaymentTableData, null,
        "_payment");
    $('#print-button').click(() => {
        window.open(documentUrl.replace(':id', appointmentId));
    });
});
const loadChannelingPaymentInfo = (data) => {
    ...
    loadChannelingPaymentTableData();
}
const loadChannelingPaymentTableData = () => {
    $(`#reason_payment`).val(appointmentNumber);
    dataTableHandler.loadData(paymentsTable, paymentUrl);
    loadData();
}
</script><div class="modal fade" id="paymentAppointmentModal" tabindex="-1" role="dialog" aria-labelledby="paymentModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
