...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">{{ __('app.headers.purchaseOrdersManagement') }}</li>
    </ol>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <h4><i class="fas fa-fw fa-shopping-cart mr-2"></i>{{ __('app.headers.purchaseOrdersManagement') }}</h4>
                <button type="button" class="btn btn-primary ml-auto" id="createButton"
                    onclick=" openCreatePurchaseOrderModal()">
...
@section('js')
    ...
    <script>
        // Load Data URL
        const indexUrl = "{{ route('purchaseOrders.index') }}";
        // View Selected Data URL
        const viewUrl = "{{ route('purchaseOrders.show', ':id') }}";
        // Delete Data URL
        const deleteUrl = "{{ route('purchaseOrders.destroy', ':id') }}";
        // Datatable ID
