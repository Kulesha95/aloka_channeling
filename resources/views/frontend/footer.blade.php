		...
		<div class="row mb-5">
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4 ml-md-4">
					...
					<ul class="list-unstyled">
						<li><a href="{{ route('frontend.index') }}"><i class="fas fa-long-arrow-alt-right mr-2"></i>Home</a></li>
						<li><a href="{{ route('frontend.about') }}"><i class="fas fa-long-arrow-alt-right mr-2"></i>About</a></li>
						<li><a href="{{ route('frontend.channelings') }}"><i class="fas fa-long-arrow-alt-right mr-2"></i>Channelings</a></li>
						<li><a href="{{ route('frontend.contact') }}"><i class="fas fa-long-arrow-alt-right mr-2"></i>Contact</a></li>
					</ul>
				</div>
			</div>
			<div class="col-md">
