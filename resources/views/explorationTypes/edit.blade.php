                ...
                <form method="POST" id="editExplorationTypeForm" data-action="{{ route('explorationTypes.update', ':id') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" name="is_numeric_value" id="is_numeric_value_edit"
                                    value="1">
                                <label class="custom-control-label" for="is_numeric_value_edit"></label>
                            </div>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
